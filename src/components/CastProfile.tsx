...
export default function CastProfile({ person, works, onBack, onDramaClick }: Props) {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-10">
          ...
          <div className="shrink-0 flex justify-center sm:justify-start">
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#C41E3A] to-[#1B2A4A] flex items-center justify-center border-2 border-[#D4AF37]/25 shadow-lg">
          ...
          {works.length > 0 ? (
            <div className="space-y-3">
              {works.map((drama, idx) => (
                ...
                >
                  {/* Mini poster */}
                  <div className={`w-14 h-20 rounded overflow-hidden shrink-0 bg-gradient-to-br ${drama.color} relative`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {idx === 0 && (
                        <span className="px-1.5 py-0.5 text-[9px] font-bold tracking-wider uppercase bg-[#D4AF37]/15 text-[#D4AF37] border border-[#D4AF37]/25 rounded-sm">
                          Latest
                        </span>
                      )}
                    </div>
